...
import type { StoreExecutionScatterData } from '../../data/storeAnalysisData';

interface StoreExecutionScatterChartProps {
  data: StoreExecutionScatterData[];
  onStoreClick?: (storeId: string) => void;
}

export function StoreExecutionScatterChart({ data, onStoreClick }: StoreExecutionScatterChartProps) {
  const option = useMemo(() => {
    const seriesData = data.map((store) => {
      ...
      return {
        value: [store.avgRating, store.replyRate24h],
        ...
        formatter: (params: any) => {
          ...
          return `<div class="font-medium">${d.name}</div>
            ...
            <div class="mt-2">
              ...
              <div>24小时回复率: <span class="font-medium">${d.value[1]}%</span></div>
